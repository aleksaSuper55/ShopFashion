...
public class ManAdapter extends RecyclerView.Adapter<ManAdapter.ViewHolder> {
    ...
    public ManAdapter(Context context, List<Product> productList) {
        this.context = context;
        this.productList = productList;
    }
    @NonNull
    @Override
    public ManAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.shop_item, parent, false);
        return new ManAdapter.ViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull ManAdapter.ViewHolder holder, int position) {
